  ...
  return (
    <ScrollView>
      ...
      <View style={styles1.welcomeContainer}>
        ...
        <Text style={styles1.welcomeText}>Welcome, Shop Admin!</Text>
        <Text style={styles1.subText}>
        Congratulations on joining WashEase! As a shop owner, you play a key role in providing laundry services to our customers. Let's get your shop up and running!
        </Text>
      </View>
