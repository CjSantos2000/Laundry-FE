  ...
  return (
    <ScrollView>
      ...
      <View style={styles1.welcomeContainer}>
        ...
        <Text style={styles1.welcomeText}>Welcome, Super Admin!</Text>
        <Text style={styles1.subText}>
        You have the power to manage and oversee the entire system. We appreciate your crucial role in keeping things running smoothly.
        </Text>
      </View>
